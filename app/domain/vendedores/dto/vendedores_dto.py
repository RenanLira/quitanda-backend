...
class CriarVendedorDTO(TypedDict):
    ...
    comunidade_id: Annotated[NotRequired[Optional[str]], Field(description="ID da comunidade associada ao vendedor", examples=["123e4567-e89b-12d3-a456-426614174000"])]
